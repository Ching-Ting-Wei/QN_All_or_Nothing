...
public: 
    ...
    vector<int> SepDijkstra(int src, int dst, int req_no, vector<vector<double>> &path_graph_X);
    vector<int> Dijkstra(vector<vector<int>>&copy_graph, int src, int dst, int req_no, vector<int>&get_delete);
