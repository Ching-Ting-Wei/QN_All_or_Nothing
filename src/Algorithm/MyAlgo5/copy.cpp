...
void MyAlgo5::path_assignment(){
    ...
    */ 
    ...
    initialize();
        ...
        cout<<"[alpha end]"<<endl;
    vector<vector<vector<double>>> path_graph_X(requests.size(), vector<vector<double>>(path_num * qubit_num + 2, vector<double>(path_num * qubit_num + 2,-1)));
    vector<vector<vector<double>>> path_graph_Y(requests.size(), vector<vector<double>>(path_num * qubit_num + 2, vector<double>(path_num * qubit_num + 2,-1)));
